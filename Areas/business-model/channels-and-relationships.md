...
## Channels — how a headmaster discovers, evaluates and buys

**Updated 13 Sep:** pricing moved from per-seat to a flat per-school fee with the whole
staff rolled out at once (see [[revenue-and-pricing]]). This shifts the sale from
...
2. **Teacher referral as the door-opener, not the close.** A teacher who's excited about it
   ...
   "adopt it, then convince the headmaster" to "introduce us to the headmaster."
3. **The free live session ("guerilla").** Two people, one real class, one lesson, filmed
   with permission. Now doubles as a live demo *for the headmaster meeting itself* — proof
   the whole staff can be onboarded in a day, not just a marketing stunt.
...
Evaluation happens in the free month, but now it's a **whole-school pilot month**, not one
class. The artefacts that close the sale are the **monthly report sample** and **usage
across the actual staff**, not just one teacher's results.

## Customer relationships — how we acquire, support and retain

### Acquire
- The headmaster meeting is now the entire sale, not the last step of a longer bottom-up
  build. One 20-minute meeting: the class flow, the report sample, EUR 199/month flat,
  first month free for everyone.
...
- **School-vs-school leaderboard.** Now real from day one — every class in the building is
  on it immediately, not just two volunteers' classes. Students ask for it; a school that
  leaves drops off the board — a small, real switching cost.
- Renewal conversation: the year in numbers, plus the teachers' own words.
