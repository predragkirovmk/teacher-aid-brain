...
One sentence per segment, then the proof behind it. The pitch uses the sentences; Q&A uses
the proof.

## Teacher — "One tool for the whole lesson, not five."
...
## Student — "A class that starts with a question."
...
| Alternative | What it does well | What it does not do |
|---|---|---|
| ChatGPT + Kahoot (free) | Plans and quizzes | Five tools, no attendance, no focus, no report, nothing in the МК curriculum, nobody sells it to the headmaster |
| Curipod | AI-generated interactive lessons, students on phones — the closest | English-first, generic curriculum, no attendance/focus, no buyer-side report, priced per teacher in USD |
| Kahoot / Quizizz / Mentimeter | Live quizzes and polls | No planning, no lesson structure, no attendance, no report |
| MagicSchool / Brisk / Eduaide | AI planning for teachers | No student side at all |
| Google Classroom / MS Teams | Distribution and homework | Nothing for the 45 minutes in the room |
| EDUINO | National content library | Not a live classroom tool; a potential partner |

One line for the stage: **"Everything else is a tool for the teacher or a game for the
students. TeacherAid is the lesson."**
